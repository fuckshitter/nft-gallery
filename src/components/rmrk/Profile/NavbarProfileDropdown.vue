<template>
  <b-dropdown position="is-bottom-left" aria-role="menu">
    ...
    <template v-if="account">
      ...
      <b-dropdown-item has-link aria-role="menuitem">
        <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" class="is-flex is-align-items-center pl-3">
          <b-icon pack="fab" icon="twitter" class="mr-1"> </b-icon>
          <strong>KodaDot</strong>
        </a>
      </b-dropdown-item>
      <b-dropdown-item has-link aria-role="menuitem">
        <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" class="is-flex is-align-items-center pl-3">
